...
export default function EditarMedidas() {
  ...
  return (
    <div className=" bg-white flex flex-col rounded-sm justify-between items-center max-w-lg">
      <h1 className="text-black">Minhas Medidas</h1>
      <p  className="text-black">Insira os valores exatos</p>
      <div className="flex py-10">
        ...
        <div className=" flex pl-3 flex-col">
          ...
          <div className="flex mt-2 flex-col">
            <button
              className="my-2 rounded-lg bg-white text-black  py-2 shadow-lg "
              onClick={() => submitFunc()}
            >
              Ver Recomedação
            </button>
